	...
	<xsl:template match="/">
		<html lang="{$lang}">
			<head>
				...
				<!--
				<script type="text/javascript" src="/ajax/auto_server.php?client=all&amp;stub=helloworld"/>
				<script type="text/javascript" src="/ajax/videolib-frontend.js"/>
-->
			...
			<body id="ng_bitflux_org">
				...
				<div id="container">
					...
					<div id="newsSearch">
						<input type="text" name="news" id="news" size="20"/>
						<input type="button" name="newsSearchSubmit" value="news" onclick="search('news'); return false;"/>
						<div id="newsList"/>
					</div>
					<div id="collectionsSearch">
						<input type="text" name="collections" id="collections" size="20"/>
						<input type="button" name="collectionsSearchSubmit" value="collections" onclick="search('collections'); return false;"/>
						<div id="collectionsList"/>
					</div>
					<div id="titleSearch">
						<input type="text" name="title" id="title" size="20"/>
						<input type="button" name="titleSearchSubmit" value="title" onclick="search('title'); return false;"/>
						<div id="titleList"/>
					</div>-->
					<!--
					<div id="banner">
