            ...
            <body onload="init();" id="body">
                ...
                <div id="container">
                    ...
                    <div id="newsView" class="fullAndFloat">
                        <div id="newsImages" class="fullAndFloat"/>
                        <div class="spacer"/>
                        <div id="newsSearch" class="fullAndFloat">
                            <div id="newsSearchBrowser" class="serachBrowser">
                                <input type="text" onkeypress="trapEnter(event, 'news');" name="news" id="news" class="search"/>
                                <input type="button" name="newsSearchSubmit" value="news" onclick="search('news'); return false;" class="button"/>
                            </div>
                            <div id="newsList"/>
                        </div>
                        <div class="spacer"/>
                        <div id="collectionsSearch" class="fullAndFloat">
                            <div id="collectionsSearchBrowser" class="serachBrowser">
                                <input type="text" onkeypress="trapEnter(event, 'collections');" name="collections" id="collections" class="search"/>
                        ...
                        <div class="spacer"/>
                        <div id="titleSearch" class="fullAndFloat">
                            <div id="titleSearchBrowser" class="serachBrowser">
                                <input type="text" onkeypress="trapEnter(event, 'title');" name="title" id="title" class="search"/>
                    ...
                    <div id="advancedSearchView" class="fullAndFloat">
                        <div id="advancedSearchBrowser" class="browser"/>
                        <div id="advancedSearchData"/>
                    </div>
