...
define('HKGMEDIALIB_WSDL_BASEDIR', $_SERVER['DOCUMENT_ROOT'] .'/hgkmedialib-urnresolver/wsdl/');

define('HKGMEDIALIB_WSDL_BASEURL', 'http://'. $_SERVER['HTTP_HOST'] . '/hgkmedialib-urnresolver/wsdl/');
